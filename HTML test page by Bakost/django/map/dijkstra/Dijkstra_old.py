...
#f = open("graph.init", "r")
#f = open("/Users/bakost/Documents/GitHub/muctr-project-1/HTML test page by Bakost/django/static/dijkstra/graph.init", "r")
...
#print("Result: ", find_shortest_path(graph, 3, 7))
